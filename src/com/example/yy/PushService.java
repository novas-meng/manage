...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST =IP.PushIp;
	...
	// Notification title
	public static String			NOTIF_TITLE = "您有新的消息"; 	
	// Notification id
	...
	private void showNotification(String text) {
		System.out.println("推送的消息为="+text);
		...
		if(!text.startsWith("admin"))
		{
			...
			mNotifMan.notify(NOTIF_CONNECTED, n);*/
				...
				PendingIntent pi = PendingIntent.getActivity(this, 0,
						...
						// Change the name of the notification here
				if(text.length()>20)
						n.setLatestEventInfo(this, NOTIF_TITLE, text.substring(0,19)+"...", pi);
				else 
					n.setLatestEventInfo(this, NOTIF_TITLE, text, pi);
						mNotifMan.notify(NOTIF_CONNECTED, n);
		...
		{
			Intent intent= new Intent(this, YYRefreshActivity.class);
			int start=text.indexOf("[");
			int end=text.indexOf("]");
			text=text.substring(start+8,end+1);
			System.out.println("text="+text);
			String type=text.substring(6,7);
