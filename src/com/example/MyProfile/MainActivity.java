   ...
   private ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   Tools.getLocalMessages(manager);
      ...
      button.setText(Constants.butlerphonenumber);
        Intent intent=this.getIntent();
    ...
    public void showOffLineNotice(ArrayList<String> list)
    {
		...
		if(list.size()>0)
		{
	    	...
	    	notice.setLatestEventInfo(MainActivity.this, "您有"+list.size()+"条新消息,来自",list.get(list.size()-1),pi);
		   ...
		   voice.setOnTouchListener(new OnTouchListener()
			{
				...
				public boolean onTouch(View arg0, MotionEvent event) {
	                ...
	                case MotionEvent.ACTION_DOWN:
						...
						//voice.setBackgroundResource(R.drawable.chat_op_file);
					...
					case MotionEvent.ACTION_UP:
						...
						voice.setBackgroundResource(R.drawable.chat_op_camera);
    ...
    public void btnClick(View v) {
        switch(v.getId())
        {
            case R.id.tsbx_phone:
            	...
            	Intent phoneintent = new Intent(Intent.ACTION_CALL,Uri.parse("tel:"+b.getText()));  
